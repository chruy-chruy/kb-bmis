                            ...
                            <div class="input__wrapper">
                             <label for="official-position">Position</label>
                              ...
                              <div class="select__wrapper">
                                <select  name="civil_status" name="civil_status" id="" class="select select--resident-profile input-viewprofile">
                           ...
                           <div class="profile-info__container">
                            <div class="input__wrapper">
                             <label for="resident-contactnumber">Phone Number</label>
                              <div class="input__inner">
                                <input  name="phone_number" type="tel" class="input--light300 input-viewprofile" value="<?php echo $row['phone_number'] ?>">
                              </div>
                            </div>
                           </div>
